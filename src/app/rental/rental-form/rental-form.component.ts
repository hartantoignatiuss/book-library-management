...
export class RentalFormComponent {
  ...
  ngOnInit() {
    if (this.route.snapshot.params['id'] === undefined) {
      ...
      forkJoin([this.rentalService.getMembers()]).subscribe(
        ([responseMembers]) => {
            ...
            .subscribe((responseData) => {
              ...
              if (responseData.id !== '') {
                ...
                this.dialog.open(RentalActionDialogComponent, {
                  data: {
                    message: 'Book is not found or unavalaible ',
                    isBack: true,
                  },
                });
              }
      ...
      this.rentalService.create(rental).subscribe(
        ...
        (error) => {
          ...
          this.dialog.open(RentalActionDialogComponent, {
            data: {
              message:
                'Fail Rental Book ' + this.book.name + '. Please try again',
              isBack: false,
            },
          });
        }
  ...
  updateBookStock(book: Book) {
    ...
    this.booksService.update(data).subscribe((response) => {
